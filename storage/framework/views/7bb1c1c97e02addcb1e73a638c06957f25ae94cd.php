...
} elseif ($_instance->childHasBeenRendered('1Dmdcl2')) {
    $componentId = $_instance->getRenderedChildComponentId('1Dmdcl2');
    $componentTag = $_instance->getRenderedChildComponentTagName('1Dmdcl2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1Dmdcl2');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('1Dmdcl2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH D:\openserver2\domains\laravel-filament-spa-i18n-vite-vue\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>