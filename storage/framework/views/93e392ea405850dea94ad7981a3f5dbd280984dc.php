...
} elseif ($_instance->childHasBeenRendered('3Pmsjcz')) {
    $componentId = $_instance->getRenderedChildComponentId('3Pmsjcz');
    $componentTag = $_instance->getRenderedChildComponentTagName('3Pmsjcz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3Pmsjcz');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('3Pmsjcz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('dpxVRwd')) {
    $componentId = $_instance->getRenderedChildComponentId('dpxVRwd');
    $componentTag = $_instance->getRenderedChildComponentTagName('dpxVRwd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dpxVRwd');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('dpxVRwd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\openserver2\domains\laravel-filament-spa-i18n-vite-vue\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>